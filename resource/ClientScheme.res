...
Scheme
{
	...
	BaseSettings
	{
		...
		Menu.TextColor				"Green"
		Menu.BgColor				"TransparentBlack"
		Menu.ArmedTextColor			"Green"
		Menu.ArmedBgColor			"Red"
		Menu.TextInset				"6"

		Chat.TypingText				"Green"

		Panel.FgColor				"GreenDim"
		Panel.BgColor				"blank"
		...
		RichText.SelectedTextColor		"Green"
		RichText.SelectedBgColor		"Blank"

		ScrollBarButton.FgColor			"Green"
		ScrollBarButton.BgColor			"Blank"
		ScrollBarButton.ArmedFgColor		"Green"
		ScrollBarButton.ArmedBgColor		"Blank"
		ScrollBarButton.DepressedFgColor	"Green"
